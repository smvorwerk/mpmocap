...
#include "MPMoCapWebSocketServer.generated.h"

UCLASS()
class MPMOCAP_API AMPMoCapWebSocketServer : public AActor
{
	GENERATED_BODY()

public:
	// Sets default values for this actor's properties
	AMPMoCapWebSocketServer();
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "MPMoCapWebSocketServer")
	void OnDataCallback(const FString &addr, const TArray<float> &data);

public:
	// Open WebSocket Server
	UFUNCTION(BlueprintCallable, Category = "MPMoCapWebSocketServer")
	bool Start(int Port);
...
private:
	...
	public:
		explicit FWebSocketConnection(INetworkingWebSocket *InSocket)
			: Socket(InSocket), Id(FGuid::NewGuid())
		{
		}
