<script lang="ts">
	...
	function onBlendshapeResult(result: TrackingResult) {
		...
		if (websocketOpen) {
			websocket.sendWebsocketMessage('/mpmocap/version', ...dataVersion);
			websocket.sendWebsocketMessage('/mpmocap/blendshapes', ...dataBlendshapes);
			websocket.sendWebsocketMessage('/mpmocap/headRotation', ...dataHead);
			websocket.sendWebsocketMessage('/mpmocap/leftEyeRotation', ...dataLeftEye);
			websocket.sendWebsocketMessage('/mpmocap/rightEyeRotation', ...dataRightEye);
		}
	}
